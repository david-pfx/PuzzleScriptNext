...
(function(mod) {
    if (typeof exports == "object" && typeof module == "object") // CommonJS
        ...
        var PRELUDE_COMMAND_WORDS = [
            ...
            ["load_images", "my_sprites=https://[...]/sprites.png", "Loads an external image to act as a spritesheet for objects."],
            ["debug_switch", "<options>", "Enables debugging to console as set by <options>. Consult source code for available options."],
            //["auto_level_titles", "", ""],
            //["puzzlescript", "", ""],
            //["youtube", "", ""],
        ];
