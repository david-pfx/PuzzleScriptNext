	                ...
	                default://if you're in the preamble
	                {
	            		...
	            		if (state.tokenIndex==0) {
		                    ...
		                    if (match!==null) {
		                    	...
		                    	if (sol) {
		                    		if (['title','author','homepage','background_color','text_color','key_repeat_interval','realtime_interval','again_interval','flickscreen','zoomscreen','color_palette','youtube','mouse_left','mouse_right','mouse_drag','mouse_rdrag','mouse_up_left','mouse_up_right'].indexOf(token)>=0) {
		                    			...
		                    			} else if (['mouse_left','mouse_right','mouse_drag','mouse_rdrag','mouse_up_left','mouse_up_right'].indexOf(token)>=0) {
											state.metadata.push(token);
		                    			...
		                    			return 'METADATA';
												 ...
												 'mouse_left','mouse_drag','mouse_right','mouse_rdrag','mouse_up_left','mouse_up_right','nokeyboard'].indexOf(token)>=0) {
		                    			state.metadata.push(token);
